...
install_soga() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/soga.tar.gz https://mirror.ghproxy.com/https://github.com/enxier/crack-soga/releases/download/${last_version}/soga-cracked-linux64.tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://mirror.ghproxy.com/https://github.com/enxier/crack-soga/releases/download/${last_version}/soga-cracked-linux64.tar.gz"
    ...
    curl -o /usr/bin/soga -Ls https://mirror.ghproxy.com/https://raw.githubusercontent.com/xieruan/air-shell/main/soga-c/soga.sh
